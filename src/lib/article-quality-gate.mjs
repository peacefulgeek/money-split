// Master scope §12 — quality gate. Union of all banned word/phrase lists.
// Any failure → REGENERATE. Never store a broken article.
...
export function voiceSignals(text) {
  ...
  const conversationalMarkers = [
    ...
    /\bstop overthinking this\b/i, /\bnobody's coming\b/i, /\blet me be straight\b/i,
